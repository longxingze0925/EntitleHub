...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    user_admin_backend::modules::ai::jobs::spawn_ai_generation_job_worker(state.clone());
    user_admin_backend::modules::web_assets::spawn_web_asset_media_worker(state.clone());
